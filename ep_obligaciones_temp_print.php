...
require_once("include/ep_obligaciones_temp_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "ep_obligaciones_temp" );
