...
function fillProjectEntites()
{
	...
	$projectEntities[ "hoja_ruta_2020_pn" ] = array( "url" => "hoja_ruta_2020_pn", "type" => 1 );
	$projectEntitiesReverse[ "hoja_ruta_2020_pn" ] = "hoja_ruta_2020_pn";
	...
	$projectEntities[ "hoja_ruta_2020_pn1" ] = array( "url" => "hoja_ruta_2020_pn1", "type" => 1 );
	$projectEntitiesReverse[ "hoja_ruta_2020_pn1" ] = "hoja_ruta_2020_pn1";
	$projectEntities[ "q_info_cont" ] = array( "url" => "q_info_cont", "type" => 1 );
	$projectEntitiesReverse[ "q_info_cont" ] = "q_info_cont";
	$projectEntities[ "q_buscador_usuarios_all" ] = array( "url" => "q_buscador_usuarios_all", "type" => 0 );
	$projectEntitiesReverse[ "q_buscador_usuarios_all" ] = "q_buscador_usuarios_all";
	$projectEntities[ "hoja_ruta_ob" ] = array( "url" => "hoja_ruta_ob", "type" => 0 );
	$projectEntitiesReverse[ "hoja_ruta_ob" ] = "hoja_ruta_ob";
	$projectEntities[ "hoja_ruta_2020" ] = array( "url" => "hoja_ruta_2020", "type" => 1 );
	$projectEntitiesReverse[ "hoja_ruta_2020" ] = "hoja_ruta_2020";
	$projectEntities[ "hoja_ruta_op" ] = array( "url" => "hoja_ruta_op", "type" => 0 );
	$projectEntitiesReverse[ "hoja_ruta_op" ] = "hoja_ruta_op";
	...
	$projectEntities[ "ep_op" ] = array( "url" => "ep_op", "type" => 0 );
	$projectEntitiesReverse[ "ep_op" ] = "ep_op";
	$projectEntities[ "ep_obligaciones_temp" ] = array( "url" => "ep_obligaciones_temp", "type" => 0 );
	$projectEntitiesReverse[ "ep_obligaciones_temp" ] = "ep_obligaciones_temp";
	$projectEntities[ "ep_registros" ] = array( "url" => "ep_registros", "type" => 0 );
	$projectEntitiesReverse[ "ep_registros" ] = "ep_registros";
	$projectEntities[ "ep_op_temp" ] = array( "url" => "ep_op_temp", "type" => 0 );
