...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("dependencias_001" == $this->chrt_array['tables'][0])
			return true;
		if("gestionpagos_ver_103_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
		...
		if("q_bandejaentrada_supervisores" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_2020_files" == $this->chrt_array['tables'][0])
			return true;
		...
		if("cargo" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_event_type" == $this->chrt_array['tables'][0])
			return true;
		...
		if("q_bandejaentrada_supervisores" == $this->chrt_array['tables'][0])
			return true;
		if("q_buscador_usuarios_all" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_ob" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_2020" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_op" == $this->chrt_array['tables'][0])
			return true;
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		if("ep_obligaciones" == $this->chrt_array['tables'][0])
			return true;
		if("ep_op" == $this->chrt_array['tables'][0])
			return true;
		if("ep_obligaciones_temp" == $this->chrt_array['tables'][0])
			return true;
		if("ep_registros" == $this->chrt_array['tables'][0])
			return true;
		if("ep_op_temp" == $this->chrt_array['tables'][0])
			return true;
		if("hoja_ruta_2020" == $this->chrt_array['tables'][0])
			return true;
		return false;
