...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		$sql = "select ". 
			...
			." from ". 
			$grConnection->addTableWrappers( "gestionpagos_ver_103_uggroups" ) .
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "gestionpagos_ver_103_ugrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "gestionpagos_ver_103_ugrights" );
