...
startDrawing(e,this)})
$(settings.clear,context).bind('click.signaturepad',function(e){e.preventDefault();clearCanvas();$.get("signature-to-image.php",{clear:$(".sigPad").attr("id")});$(".pad").css("background","none");})
