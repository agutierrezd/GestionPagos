...
$nonAdminTablesArr[] = "hoja_ruta_2020_pn";
...
$nonAdminTablesArr[] = "hoja_ruta_2020_pn1";
$nonAdminTablesArr[] = "q_info_cont";
$nonAdminTablesArr[] = "q_buscador_usuarios_all";
$nonAdminTablesArr[] = "hoja_ruta_ob";
$nonAdminTablesArr[] = "hoja_ruta_2020";
$nonAdminTablesArr[] = "hoja_ruta_op";
$nonAdminTablesArr[] = "contractor_master";
$nonAdminTablesArr[] = "ep_obligaciones";
$nonAdminTablesArr[] = "ep_op";
$nonAdminTablesArr[] = "ep_obligaciones_temp";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestionpagos_ver_103_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestionpagos_ver_103_ugrights" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
		
		$sql = "delete from ".$ug_connection->addTableWrappers( "gestionpagos_ver_103_ugmembers" ) 
			." where ". $ug_connection->addFieldWrappers( "GroupID" ) ."=".(postvalue_number("id"));
		$ug_connection->exec( $sql );
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestionpagos_ver_103_ugrights" );
