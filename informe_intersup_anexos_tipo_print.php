...
require_once("include/informe_intersup_anexos_tipo_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "informe_intersup_anexos_tipo" );
