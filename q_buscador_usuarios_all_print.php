...
require_once("include/q_buscador_usuarios_all_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "q_buscador_usuarios_all" );
